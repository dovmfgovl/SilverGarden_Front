...
import { messageDelete, messageFileDownload, messageRead, messageStore } from '../../services/api/messageApi';

const MessageReceiveDetail = ({handleMenu, empData, messageDetail}) => {

  const messageReadChange = async() =>{
    if(messageDetail.read_status === 'N'){
      await messageRead({r_id:empData.e_no, me_no:messageDetail.me_no});
    }
  }
...
export default MessageReceiveDetail