  ...
  return (
    ...
    <div className={styles.approvalTable}>
      ...
      <tbody>
        <tr style={{height:'50px'}}>
          <td>{lineData.approvalLine[0] && lineData.approvalLine[0].ap_result === '승인' ? <img src={approvalImg} style={{height:'40px'}} alt="결재"/> : ""}</td>
          <td>{lineData.approvalLine[1] && lineData.approvalLine[1].ap_result === '승인' ? <img src={approvalImg} style={{height:'40px'}} alt="결재"/> : ""}</td>
          <td>{lineData.approvalLine[2] && lineData.approvalLine[2].ap_result === '승인' ? <img src={approvalImg} style={{height:'40px'}} alt="결재"/> : ""}</td>
        </tr>
      </tbody>
    </Table>
    </div>
    <div className={styles.agreeTable}>
      <Table className='mb-0 mt-0' striped bordered size="sm">
        ...
        <tbody>
          <tr style={{height:'50px'}}>
            <td>{lineData.agreement[0] && lineData.agreement[0].ap_result === '승인' ? <img src={agreementImg} style={{height:'40px'}} alt="합의"/> : ""}</td>
            <td>{lineData.agreement[1] && lineData.agreement[1].ap_result === '승인' ? <img src={agreementImg} style={{height:'40px'}} alt="합의"/> : ""}</td>
            <td>{lineData.agreement[2] && lineData.agreement[2].ap_result === '승인' ? <img src={agreementImg} style={{height:'40px'}} alt="합의"/> : ""}</td>
          </tr>
        </tbody>
      </Table>
    </div>
